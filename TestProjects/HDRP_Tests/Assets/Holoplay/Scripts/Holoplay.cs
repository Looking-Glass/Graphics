...
namespace LookingGlass {
	...
	public class Holoplay : MonoBehaviour {
        ...
        void Start()
        {
            //Debug.Log(cal.screenWidth);
            //Debug.Log(cal.screenHeight);
            //Debug.Log(cal.pitch);
            //Debug.Log(cal.slope);
...
//			lightfieldCam.clearFlags = CameraClearFlags.Nothing;
        ...
        void Update() {
            ...
            if (Input.GetKeyDown(screenshotQuiltKey)) {
				...
				quiltRT = tempQuilt;
				RenderQuilt(); // renders the lightfield
        ...
        public HoloMatrix GetMatrices()
        {
            ...
            for (int i = 0; i < quiltSettings.numViews; i++)
            {
                ...
                //holoMatrix.viewMatrices.Add(viewMatrix);
                //holoMatrix.projectionMatrices.Add(projMatrix);
                holoMatrix.viewMatrices.Add(centerViewMatrix);
                holoMatrix.projectionMatrices.Add(centerProjMatrix);
            }
            return holoMatrix;
        }
